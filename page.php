...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <header style="height: 450px; background-position: center; background-repeat: no-repeat; background-size: cover; background: linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.25)), url('<?php the_post_thumbnail_url('full'); ?>');">
            <div class="container">
                <div class="row">
