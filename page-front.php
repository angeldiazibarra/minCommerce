...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <header class="pageheader" style="background: linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.25)), url('<?php the_post_thumbnail_url('full'); ?>');background-position: center;background-repeat: no-repeat;background-size:cover;background-attachment: fixed;">
            <div class="container">
                <div class="row">
