            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                        ...
                        <p><i>"Empresa seria donde las haya, de plena confianza. Cuidan los detalles al máximo y consiguen acabados muy profesionales. Ha sido un placer trabajar con ellos!"</i></p>
                    </div>
                    <div class="col-xs-12 col-md-8 col-md-offset-2">
                        <h4>María I.</h4>
                        <p>Reforma de un piso en Zaragoza</p>
                        <p><i>"Desde el principio en EUDOMUS tuvieron en cuenta todas nuestras preferencias, estamos muy contentos por la ejecución del proyecto y el resultado final. Todo el mundo que viene a casa se sorprende de cómo ha quedado."</i></p>
                    </div>
                </div>
            </div>
        </section> 